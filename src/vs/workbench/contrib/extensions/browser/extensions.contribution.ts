...
import {
	// Action2, IAction2Options, IMenuItem, MenuId, MenuRegistry,
	registerAction2
...
import {
	// ContextKeyExpr, IContextKeyService,
	RawContextKey
...
import {
	// EXTENSION_INSTALL_SOURCE_CONTEXT, ExtensionInstallSource, ExtensionRequestsTimeoutConfigKey, ExtensionsLocalizedLabel, FilterType, IExtensionGalleryService,
	IExtensionManagementService,
	InstallOptions,
	// PreferencesLocalizedLabel, SortBy, VerifyExtensionSignatureConfigKey
...
// import { IExtensionManagementServerService, IPublisherInfo, IWorkbenchExtensionEnablementService } from '../../../services/extensionManagement/common/extensionManagement.js';
...
import { ExtensionEditorTab, IExtensionsViewPaneContainer, IExtensionsWorkbenchService, VIEWLET_ID } from '../common/extensions.js';
...
import { ManageExtensionsQuickAccessProvider } from './extensionsQuickAccess.js';
// import { InstallExtensionQuickAccessProvider } from './extensionsQuickAccess.js';
import { ExtensionsViewPaneContainer, MaliciousExtensionChecker, StatusUpdater } from './extensionsViewlet.js';
// import { BuiltInExtensionsContext, ExtensionMarketplaceStatusUpdater, ExtensionsSearchValueContext, ExtensionsSortByContext, ExtensionsViewletViewsContribution, RecommendedExtensionsContext, SearchHasTextContext, SearchMarketplaceExtensionsContext } from './extensionsViewlet.js';
		...
		try {
			if (typeof arg === 'string') {
				...
				if (extension) {
					...
					// Note: installVersion method doesn't exist, using install instead
				...
				// Note: installOnlyNewlyAddedFromExtensionPack is not available in InstallExtensionOptions
